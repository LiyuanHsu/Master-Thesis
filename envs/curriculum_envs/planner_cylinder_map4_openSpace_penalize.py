...
class PlannerCylinderMap4_openSpace_penalize(gym.Env):
    metadata = {
    ...
    def __init__(self):
        ...
        self.obstacle_type = ['cylinder', 'cylinder', 'cylinder']
        ...
        if not self.manual_pose:
            ...
            for it_obstacle in range(self.obstacle_num):
                if self.obstacle_type[it_obstacle] == 'cylinder':
                    ...
                    self.obstacle_pos[0, 0:2] = [5.0, 3.0]
                    self.obstacle_pos[1, 0:2] = [3.0, 5.0]
                    self.obstacle_pos[2, 0:2] = [7.2, 6.2]
