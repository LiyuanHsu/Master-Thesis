...
class PlannerRectangleMap1(gym.Env):
    metadata = {
    ...
    def __init__(self):
        ...
        self.obstacle_type = ['rectangle', 'rectangle', 'rectangle', 'rectangle', 'rectangle', 'rectangle', 'rectangle']
    ...
    def _step(self, action):
        ...
        if done:
            ...
            if collision:
                ...
                if np.linalg.norm(self.goal_pos - self.state[0:2]) < 0.4:
                    reward = 1.0
                    done = True
                else:
        ...
        if not self.manual_pose:
            ...
            for it_obstacle in range(self.obstacle_num):
                if self.obstacle_type[it_obstacle] == 'cylinder':
                    ...
                    # Obstacles
                    self.obstacle_pos[4, 0] = 2
                    self.obstacle_pos[4, 1] = 5
                    self.obstacle_pos[4, 2] = 0.1

                    self.obstacle_pos[5, 0] = 4
                    self.obstacle_pos[5, 1] = 2.5
                    self.obstacle_pos[5, 2] = 0.4

                    self.obstacle_pos[6, 0] = 5.2
                    self.obstacle_pos[6, 1] = 6.3
                    self.obstacle_pos[6, 2] = 2.7
                    ...
                    # Without dead-end
                    self.obstacle_dim = [np.array([0.2, 9.2]), np.array([0.2, 9.2]), np.array([9.2, 0.2]), np.array([9.2, 0.2]), np.array([0.4, 0.4]), np.array([3, 2]), np.array([5, 1])]
