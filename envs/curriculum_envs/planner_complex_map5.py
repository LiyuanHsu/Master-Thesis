...
class PlannerComplexMap5(gym.Env):
    metadata = {
        ...
        if not self.manual_pose:
            ...
            for it_obstacle in range(self.obstacle_num):
                if self.obstacle_type[it_obstacle] == 'cylinder':
                    ...
                    self.obstacle_pos[11, 0:2] = [0.3, 7]
                    ...
                    self.obstacle_pos[4, 1] = 2.5

                    self.obstacle_pos[5, 0] = 6.5
                    self.obstacle_pos[5, 1] = 2.5

                    self.obstacle_pos[6, 0] = 2.5
                    self.obstacle_pos[6, 1] = 6.5

                    self.obstacle_pos[7, 0] = 6.5
                    self.obstacle_pos[7, 1] = 6.5

                    self.obstacle_pos[8, 0] = 2.25
                    self.obstacle_pos[8, 1] = 0.3

                    self.obstacle_pos[9, 0] = 6
                    self.obstacle_pos[9, 1] = 8.8
                    ...
                    # Without dead-end
                    self.obstacle_dim = [np.array([0.2, 9.2]), np.array([0.2, 9.2]), np.array([9.2, 0.2]), np.array([9.2, 0.2]), np.array([2, 2]), np.array([2, 2]), np.array([2, 2]), np.array([2, 2]), np.array([0.3, 0.6]), np.array([0.5, 0.5])]
