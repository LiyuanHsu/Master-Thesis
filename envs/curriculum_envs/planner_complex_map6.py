...
class PlannerComplexMap6(gym.Env):
    metadata = {
    ...
    def __init__(self):
        ...
        self.obstacle_type = ['rectangle', 'rectangle', 'rectangle', 'rectangle', 'rectangle', 'rectangle', 'rectangle', 'rectangle','rectangle', 'rectangle', 'cylinder', 'cylinder', 'cylinder', 'cylinder', 'cylinder']
        ...
        if not self.manual_pose:
            ...
            for it_obstacle in range(self.obstacle_num):
                if self.obstacle_type[it_obstacle] == 'cylinder':
                    ...
                    self.obstacle_pos[10, 0:2] = [4.5, 4.5]
                    self.obstacle_pos[11, 0:2] = [1.2, 7]
                    self.obstacle_pos[12, 0:2] = [7, 4.2]
                    self.obstacle_pos[13, 0:2] = [3, 8]
                    self.obstacle_pos[14, 0:2] = [4, 2]


                    # radius = 0.25
                    # self.obstacle_dim.append(radius)

                    cylinder_dim = [0.2, 0.2, 0.3, 0.3, 0.4]
                    ...
                    self.obstacle_pos[4, 0] = 2.5
                    self.obstacle_pos[4, 1] = 5.7
                    self.obstacle_pos[4, 2] = 8

                    self.obstacle_pos[5, 0] = 6.5
                    self.obstacle_pos[5, 1] = 2.2
                    self.obstacle_pos[5, 2] = 9

                    self.obstacle_pos[6, 0] = 1.5
                    self.obstacle_pos[6, 1] = 2.8
                    self.obstacle_pos[6, 2] = 10

                    self.obstacle_pos[7, 0] = 7.7
                    self.obstacle_pos[7, 1] = 5.8
                    self.obstacle_pos[7, 2] = 11.2

                    self.obstacle_pos[8, 0] = 2.25
                    self.obstacle_pos[8, 1] = 1.2
                    self.obstacle_pos[8, 2] = 12

                    self.obstacle_pos[9, 0] = 5.8
                    self.obstacle_pos[9, 1] = 7
                    self.obstacle_pos[9, 2] = 0.5
                    ...
                    # Without dead-end
                    self.obstacle_dim = [np.array([0.2, 9.2]), np.array([0.2, 9.2]), np.array([9.2, 0.2]), np.array([9.2, 0.2]), np.array([1, 1]), np.array([1.5, 1]), np.array([0.8, 0.3]), np.array([1, 0.2]), np.array([0.3, 0.6]), np.array([0.5, 1])]
            ...
            self.obstacle_dim = self.obstacle_dim + cylinder_dim
