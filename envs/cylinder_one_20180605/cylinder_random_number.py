...
class CylinderRandomNumber(gym.Env):
    metadata = {
    ...
    def __init__(self):
        ...
        self.obstacle_radius = 0.05 * np.ones(self.obstacle_num)
    ...
    def _reset(self):
        ...
        # self.obstacle_num = np.random.randint(1, 6, 1)[0]
        # self.obstacle_radius = 0.05 * np.ones(self.obstacle_num)
        # self.obstacle_pos = np.zeros((self.obstacle_num, 2))
        ...
        for it in range(self.obstacle_num):
            ...
            obstacle_y = np.random.uniform(-1.5, 1.5, 1)
    ...
    def _render(self, mode='human', close=False):
        ...
        if self.obstacle_num == 1:
            ...
            for it_obstacle in range(self.obstacle_num):
                ...
                print (self.obstacle_num)
                print (self.obstacle_trans)
